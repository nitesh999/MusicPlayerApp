...
class SecondFragment : Fragment() {
    ...
    private lateinit var mMusicPlayerService: MyOreoService
    ...
    override fun onStart() {
        ...
        val intent = Intent(mContext, MyOreoService::class.java)
        ...
        LocalBroadcastManager.getInstance(mContext.getApplicationContext())
            .registerReceiver(mReceiver, IntentFilter(MyOreoService.MUSIC_COMPLETE))
    }
    ...
    private val mServiceCon: ServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName, iBinder: IBinder) {
            val myServiceBinder: MyOreoService.MyServiceBinder = iBinder as MyOreoService.MyServiceBinder
